        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              <StatCard title="Total Users" value={dashboard.stats.totalUsers.toLocaleString()} icon={Users} color="bg-blue-500" subtitle={`+${dashboard.stats.newUsersThisMonth} this month`} />
              <StatCard title="Total Products" value={dashboard.stats.totalProducts.toLocaleString()} icon={Package} color="bg-green-500" subtitle={`${dashboard.stats.activeProducts} active`} />
              <StatCard title="Total Orders" value={dashboard.stats.totalOrders.toLocaleString()} icon={ShoppingCart} color="bg-purple-500" subtitle={`${dashboard.stats.monthOrders} this month`} />
